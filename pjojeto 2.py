...
myButton1=Button(frame, text='Limpar', width=20, fg='#fff', bg='black', pady=3, command=lambda:button_click(1))
myButton1.pack()

myButton = Button(buttons, text='Rolar dado',fg='#fff', bg='black',width=20, pady=3, command=lambda:rolar_dado(c))
myButton.pack()
# Botões de rotação
myButton2=Button(buttons, text='Rotacionar 45', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(2))
myButton2.pack()
myButton3=Button(buttons, text='Rotacionar 90', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(3))
myButton3.pack()
myButton4=Button(buttons, text='Rotacionar 180', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(4))
myButton4.pack()

# Botões de escala
myButton5=Button(buttons, text='Escala (2,2)', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(5))
myButton5.pack()
myButton6=Button(buttons, text='Escala (3,3)', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(6))
myButton6.pack()
myButton7=Button(buttons, text='Escala (3,4)', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(7))
myButton7.pack()

# Botões de translação
myButton8=Button(buttons, text='Translação Cima', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(8))
myButton8.pack()
myButton9=Button(buttons, text='Translação Direita', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(9))
myButton9.pack()
myButton8=Button(buttons, text='Translação Esquerda', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(10))
myButton8.pack()
myButton9=Button(buttons, text='Translação Baixo', fg='#fff', bg='black', width=20, pady=3, command=lambda:button_click(11))
myButton9.pack()
